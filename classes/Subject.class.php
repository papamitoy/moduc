...
class Subject{
    ...
    $stmt = $conn->prepare("SELECT a.email,a.username,a.type,b.subject_name,b.class_name,b.section_name from tbl_users a left join tbl_subjects b on a.id = b.user_id where b.user_id = :id");
    ...
    <div class="col-md-6 col-lg-6 col-xl-4 box-col-6">
        <div class="card custom-card">
            ...
            <div class="col-4 col-sm-4">
                ...
                <button onclick="document.location='../components/subject-stream.php'" class="btn_1 w-100 mb-2 btn-lg email-gradient gradient-9-hover email__btn waves-effect">View</button>
...
public static function getEnrolledSubjects(){
    ...
    include "connection/db.php";
    $stmt = $conn->prepare("SELECT a.email,a.username,a.type,b.subject_name,b.class_name,b.section_name from tbl_enroll c 
