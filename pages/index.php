...
<!-- main content part here -->
 <section class="main_content dashboard_part large_header_bg">
	...
	<!-- join modal popup -->
	<?php include 'components/join.class.php'?>
	<!-- end modal popup -->

    <!-- create modal popup -->
	<?php include 'components/create.class.php'?>
	<!-- end modal popup -->
...
<!-- text editor js -->
<script src="pages/vendors/text_editor/summernote-bs4.js"></script>
<script src="pages/vendors/am_chart/amcharts.js"></script>

<!-- scrollabe  -->
<script src="pages/vendors/scroll/perfect-scrollbar.min.js"></script>
<script src="pages/vendors/scroll/scrollable-custom.js"></script>

<!-- vector map  -->
<script src="pages/vendors/vectormap-home/vectormap-2.0.2.min.js"></script>
<script src="pages/vendors/vectormap-home/vectormap-world-mill-en.js"></script>

<!-- apex chrat  -->
<script src="pages/vendors/apex_chart/apex-chart2.js"></script>
<script src="pages/vendors/apex_chart/apex_dashboard.js"></script>

<script src="pages/vendors/echart/echarts.min.js"></script>


<script src="pages/vendors/chart_am/core.js"></script>
<script src="pages/vendors/chart_am/charts.js"></script>
<script src="pages/vendors/chart_am/animated.js"></script>
<script src="pages/vendors/chart_am/kelly.js"></script>
<script src="pages/vendors/chart_am/chart-custom.js"></script>
<!-- custom js -->
<script src="pages/js/dashboard_init.js"></script>
